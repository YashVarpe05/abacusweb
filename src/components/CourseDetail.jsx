...
const courseData = {
	abacus: {
		...
		highlights: [
			...
			"Abacus is totally Brian Development Scores",
			"Photographic Memory",
		...
		image:
			"/src/assets/img/360_F_66101698_E6pVObW2WsQcAa56eFOJpI54BFbCDkGI.webp", // Replace with actual image paths
		additionalImages: [
	...
	"handwriting-improvement": {
		...
		description: `A program focused on improving writing skills, covering cursive, script, and speed writing techniques. Ideal for those seeking legibility, speed, and professional handwriting improvement.`,
		highlights: [
		...
		image: "/path/to/handwriting-image.jpg",
	},
};
